...
"""Custom event functions for the spread_tablecloth task."""
...
def reset_robot_to_default_joint_positions(
    ...
    Writes joint positions and velocities to the simulation directly,
    bypassing the PD controller to prevent arm swing on reset.
    """
    if len(env_ids) == 0:
        return
