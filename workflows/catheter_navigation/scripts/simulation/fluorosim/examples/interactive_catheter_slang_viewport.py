...
import torch
import warp as wp
from fluorosim.catheter import XCathRodSolver  # noqa: E402
from fluorosim.catheter.rod_data import RodConfig  # noqa: E402
from fluorosim.catheter.xcath_rod_solver import compute_signed_distances  # noqa: E402
...
class KeyboardDriveController:
    ...
    def __init__(self, max_velocity_mm_s: float = 16.0, max_torque: float = 1.5):
        self.max_velocity_mm_s = max_velocity_mm_s
        self.max_torque = max_torque
        self.fast_scale = 1.8
        self.slow_scale = 1.0
