...
class SurgicalLiftNeedleEnvironment(SurgicalStateMachineEnvironmentBase):
    name: str = "surgical_lift_needle"
    state_machine_module: str = "arena.statemachine.surgical_lift_needle"
    ...
    def get_env(self, args: argparse.Namespace) -> Any:
        ...
        scene = Scene(assets=make_surgical_scene_assets("lift_needle"))
        task = SurgicalLiftTask(task_description="Lift the suture needle with the dVRK PSM.", organs=False)
