...
try:
    from ._aja_source import AJASourceOp  # noqa: F401
...
See https://docs.nvidia.com/holoscan/sdk-user-guide/holoscan_create_operator_python_bindings.html\
#pybind11-abi-compatibility for details.
"""
...
try:
    ...
    from ._aja_source import register_types as _register_types
