...
PYDOC(DDSHIDSubscriberOp, R"doc(
DDS HID Subscriber operator.
)doc")

// PyDDSHIDSubscriberOp Constructor
PYDOC(DDSHIDSubscriberOp_python, R"doc(
DDS HID Subscriber operator.
...
hid_device_filters : list, optional
    List of device paths to capture HID events from.
name : str, optional
