...
function(add_pybind11_module)
    ...
    file(MAKE_DIRECTORY ${PYTHON_MODULE_OUT_DIR}/${MODULE_NAME})

    # custom target to ensure the module's __init__.py file is copied
    set(CMAKE_SUBMODULE_OUT_DIR ${PYTHON_MODULE_OUT_DIR}/${MODULE_NAME})
    configure_file(
        ${CMAKE_CURRENT_FUNCTION_LIST_DIR}/pybind11/__init__.py
        ${PYTHON_MODULE_OUT_DIR}/${MODULE_NAME}/__init__.py
    )
