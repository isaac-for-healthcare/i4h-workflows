...
class BlockHandoverEnvCfg(HandoverEnvCfg):
    def __post_init__(self):
        ...
        self.scene.object = RigidObjectCfg(
            ...
            init_state=RigidObjectCfg.InitialStateCfg(pos=(-0.05, 0.0, 0.05), rot=(1, 0, 0, 0)),
            spawn=UsdFileCfg(
                usd_path=f"{ROBOTICSURGERY_ASSETS_DATA_DIR}/Props/Surgical_block/block.usd",
