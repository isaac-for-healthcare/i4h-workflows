...
def main():
    ...
    parser.add_argument(
        "--policy", type=str, default="gr00tn1_g1", choices=["pi0", "gr00tn1", "gr00tn1_g1"], help="policy type to use (pi0 or gr00tn1)."
    )
    parser.add_argument(
        "--chunk_length",
        type=int,
