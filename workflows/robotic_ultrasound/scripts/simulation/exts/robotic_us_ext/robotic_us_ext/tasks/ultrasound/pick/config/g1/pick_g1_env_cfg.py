...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    packing_table = AssetBaseCfg(
        ...
        init_state=AssetBaseCfg.InitialStateCfg(pos=[0.0, 0.55, 0.0], rot=[1.0, 0.0, 0.0, -180.0]),
        spawn=UsdFileCfg(
    ...
    object = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(pos=[0.45, 0.40, 0.83], rot=[1, 0, 0, 0]),
        spawn=sim_utils.UsdFileCfg(
            usd_path="/home/yunliu/Downloads/c3hd3_fixed.usda",
    ...
    organs = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(
            pos=[-0.12, 0.53, 0.934], rot=euler_angles_to_quats(torch.tensor([0.0, 0.0, 90.0]), degrees=True)
        ),
        spawn=sim_utils.UsdFileCfg(
...
class ActionsCfg:
    ...
    # g1_action: ActionTermCfg = MISSING
    ...
    def __post_init__(self):
        ...
        self.scene.robot_pov_cam = CameraCfg(
            ...
            offset=CameraCfg.OffsetCfg(
                pos=(0, -0.2, 1.4), rot=(0.4226, -0.9063, 0.0, 0.0), convention="ros"
            ),
            prim_path="{ENV_REGEX_NS}/RobotPOVCam",
            update_period=0,
            data_types=["rgb", "distance_to_image_plane"],
