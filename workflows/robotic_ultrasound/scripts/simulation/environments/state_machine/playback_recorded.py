...
"""
This script plays back recorded demonstrations from HDF5 format.

.. code-block:: bash

    # Usage for HDF5 format
    ## Absolute actions
    python scripts/state_machine/playback_recorded.py --data_path /media/m3/repos/robotic_ultrasound_internal/data/hdf5/2025-01-24-Isaac-Teleop-Torso-FrankaUsRs-IK-RL-Rel-v0/valid_copy --task Isaac-Reach-Torso-FrankaUsRs-IK-RL-Abs-v0 --enable_camera
    ## Relative actions
    python scripts/state_machine/playback_recorded.py --data_path /media/m3/repos/robotic_ultrasound_internal/data/hdf5/2025-01-24-Isaac-Teleop-Torso-FrankaUsRs-IK-RL-Rel-v0/valid_copy --task Isaac-Teleop-Torso-FrankaUsRs-IK-RL-Rel-v0 --enable_camera --use_rel
"""
...
parser.add_argument(
    ...
    type=str, 
    required=True,
    help="Path to either .hdf5 file containing recorded data."
)
...
from simulation.environments.state_machine.utils import get_robot_obs, compute_relative_action
...
def main():
    ...
    while simulation_app.is_running():
        ...
        reset_tensor = torch.tensor(get_observation_episode_data(args_cli.data_path, episode_idx, 'observations/robot_obs')[0], device='cuda:0')
        with torch.inference_mode():
            for episode_idx in range(total_episodes):
                ...
                reset_organ_to_position(env, object_position)
                robot_initial_joint_state = get_observation_episode_data(args_cli.data_path, episode_idx + 1, joint_state_key)
                reset_robot_to_position(env, robot_initial_joint_state)
