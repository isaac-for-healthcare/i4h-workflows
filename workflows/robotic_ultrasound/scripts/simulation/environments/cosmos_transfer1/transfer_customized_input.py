...
from simulation.environments.cosmos_transfer1.utils.preprocessors import Preprocessors
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--prompt",
        type=str,
        default="The video captures a stunning, photorealistic scene with remarkable attention to detail,"
        "giving it a lifelike appearance that is almost indistinguishable from reality. It appears to be"
        "from a high-budget 4K movie, showcasing ultra-high-definition quality with impeccable resolution.",
    ...
    parser.add_argument(
        ...
        "The geometries are very primitive. The images are very pixelated and of poor CG quality. There are many"
        " subtitles in the footage. Overall, the video is unrealistic at all.",
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="path to video mask file. This is used to control the generation of the video.",
    )
    parser.add_argument(
        "--foreground_label",
        type=str,
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.2866e00,
        help="This controls how many guidance steps are performed during generation. "
        "Smaller values mean more steps, larger values mean less steps.",
    )
