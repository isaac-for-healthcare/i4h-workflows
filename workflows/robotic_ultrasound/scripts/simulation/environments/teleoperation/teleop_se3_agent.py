...
from simulation.environments.state_machine.utils import compute_transform_matrix, get_joint_states, get_probe_pos_ori
...
def main():
    ...
    transform_matrix = compute_transform_matrix(
        ov_point=(env.unwrapped.scene["organs"].data.root_pos_w[0]).cpu().numpy()
        * 1000.0,  # initial position of the organ in isaac sim
