...
def main():
    ...
    pi0_group.add_argument(
        "--repo_id",
        type=str,
        default="datasets/so101_sim_scissors",
        help="LeRobot repo id for the dataset norm. Default is `datasets/so101_sim_scissors`",
    )
    ...
    parser.add_argument(
        "--policy", type=str, default="gr00tn1.5", choices=["pi0", "gr00tn1", "gr00tn1.5"], help="policy type to use (pi0 or gr00tn1 or gr00tn1.5)."
    )
    parser.add_argument(
        "--chunk_length",
        type=int,
