...
:mod:`i4h_arena.embodiments.so_arm`).
"""
...
from i4h_arena.assets.constants import SCISSOR_TABLE_USD, SCISSOR_TRAY_USD, SCISSORS_USD
from i4h_arena.embodiments.so_arm import SOARM_ROOM_CAMERA_CFG, SOARM_WRIST_CAMERA_CFG


@configclass
class SoArmScissorsSceneCfg(InteractiveSceneCfg):
    ground = AssetBaseCfg(
    ...
    table = AssetBaseCfg(
        ...
        init_state=AssetBaseCfg.InitialStateCfg(pos=(0.1, 0.0, 0.0), rot=(0.0, 0.0, 0.707, 0.707)),
    ...
    scissors = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(pos=(0.12, -0.02, 0.253), rot=(0.0, 0.0, 0.707, 0.707)),
        spawn=sim_utils.UsdFileCfg(
    ...
    tray = AssetBaseCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(pos=(0.12, 0.25, 0.26), rot=(0.0, 0.0, 0.7071, 0.7071)),
        spawn=sim_utils.UsdFileCfg(
...
def make_assets() -> list[ConfigAsset]:
    ...
    source = SoArmScissorsSceneCfg(env_spacing=4.0)
    asset_names = (
        "ground",
        "table",
        "scissors",
