...
vtk.vtkOutputWindow().SetGlobalWarningDisplay(0)  # Suppress VTK warnings
...
def convert_to_mesh(
    ...
    if len(label_values.keys()) > 1:
        ...
        render_window.SetOffScreenRendering(True)  # Enable headless rendering
    ...
    if isinstance(mesh, trimesh.Scene):
        for node_name in mesh.graph.nodes:
            ...
            if geom_name is not None and geom_name.startswith("mesh"):
                ...
                _ = UsdGeom.Xform.Define(stage, node_path)
