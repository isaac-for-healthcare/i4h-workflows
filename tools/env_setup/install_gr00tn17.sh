...
echo "--- Installing GR00T N1.7 Policy Dependencies ---"

GR00T_DIR="$PROJECT_ROOT/third_party/Isaac-GR00T"
DEFAULT_GR00T_COMMIT="4b1dca9d88d2a0b9ea5a65aa61c82ff89f5c4f0e"
...
echo "GR00T N1.7 Policy Dependencies installed."
