...
The dataset and model layout remains compatible with the released checkpoints.
"""
...
from i4h_tasks.openpi_pi0.ultrasound.utils import LeRobotDataConfig
    ...
    return TrainConfig(
        ...
        data=LeRobotDataConfig(
            ...
            base_config=DataConfig(
                ...
                # Workflow LeRobot converter writes the action sequence under "action"
