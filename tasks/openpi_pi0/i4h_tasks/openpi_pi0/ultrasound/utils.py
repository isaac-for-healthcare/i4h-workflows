...
"""openpi DataConfig adapter carried forward for the LeRobot ultrasound dataset."""
...
def compute_normalization_stats(config, max_frames: int | None = None, batch_size: int = 1) -> None:
    """Compute and persist openpi normalization statistics for the configured dataset."""
    import jax
    import tqdm
...
class LeRobotDataConfig(DataConfigFactory):
    def create(self, assets_dirs: pathlib.Path, model_config: _model.BaseModelConfig) -> DataConfig:
        # Workflow LeRobot converter writes v2-style keys: observation.images.<cam>,
